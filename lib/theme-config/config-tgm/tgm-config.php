 ...
 */
function cassandra_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'      => esc_html__('CMB2','cassandra-lite'),
			'slug'      => 'cmb2',
			'required'  => true,
		)
	); 
	 ...
	 */
	$config = array(
		'id'           => 'cassandra_lite',                 // Unique ID for hashing notices for multiple instances of TGMPA.
